...
"$dotnetpath" restore "../ServiceCity.sln" -p:Configuration=$releaseconf ${@:2}
checkerror $? "Failed to download packages"

# Build
echo Building...
"$dotnetpath" build "../ServiceCity.sln" -p:Configuration=$releaseconf ${@:2}
checkerror $? "Failed to build ServiceCity"

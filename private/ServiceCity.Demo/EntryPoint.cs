...
using ServiceCity.Tools;
using Terminaux.Writer.ConsoleWriters;
using Terminaux.Writer.CyclicWriters;

namespace ServiceCity.Demo
{
    internal class EntryPoint
    {
        private static void Main()
        {
            ...
            var serviceList = ServiceEnumerator.EnumerateServices();

            // List them in a nice way
            var listing = new Listing()
            {
                Objects = serviceList,
                Stringifier = service => ((SystemService)service).DisplayName
            };
